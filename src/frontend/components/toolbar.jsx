...
import styles from '../styles/itinerary_page/toolbar.module.css';

export default function FloatingToolbar() {
    return (
        <div className={styles.toolbarContainer}>
            
            {/* 1. LEFT GROUP: Brand / Logo */}
            <div className={styles.leftGroup}>
                <div className={styles.brandBox}>
                    <div className={styles.logoCircle}>
                        {/* YOUR CUSTOM LOGO SVG */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
                            <path d="M232,80,208,96v24a96,96,0,0,1-96,96H24a8,8,0,0,1-6.25-13L104,99.52V76.89c0-28.77,23-52.75,51.74-52.89a52,52,0,0,1,50.59,38.89Z" opacity="0.2"></path>
            ...
            {/* 2. RIGHT GROUP: Navigation Links */}
            <div className={styles.centerGroup}>
                <button className={styles.navLink}>About</button>
                <button className={styles.navLink}>Creators</button>
                <button className={styles.navLinkHighlight}>Contact Us</button>
            </div>
