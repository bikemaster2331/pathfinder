...
export default function ItineraryPage() {
    ...
    const [isTripForecastVisible, setIsTripForecastVisible] = useState(false);
    ...
    return (
        <div className={`${styles.itineraryContainer} ${isMapFullscreen ? styles.itineraryContainerFullscreen : ''} ${(!activeHub || !dateRange.start || !dateRange.end) ? styles.itineraryNoSidebar : ''} ${isChatMinimized ? styles.itineraryContainerChatMinimized : ''}`}>
            ...
            <div className={`${styles.mapArea} ${isMapFullscreen ? styles.mapAreaFullscreen : ''}`}>
                <MapWrapper
                    ref={mapRef}
                    isTripForecastVisible={isTripForecastVisible}
                ...
                <div className={styles.mapTopControlsGroup}>
                    <button
                        type="button"
                        className={styles.mapHelpToggle}
                        onClick={() => setIsTripForecastVisible((prev) => !prev)}
                        title="Toggle Trip Forecast"
                        aria-label="Toggle Trip Forecast"
                    >
